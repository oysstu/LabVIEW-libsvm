...
<Project Type="Project" LVVersion="15008000">
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="LabVIEW-liblinear.so" Type="Document" URL="../bin/LabVIEW-liblinear.so"/>
			<Item Name="LabVIEW-libsvm-dense.so" Type="Document" URL="../bin/LabVIEW-libsvm-dense.so"/>
			<Item Name="LabVIEW-libsvm.so" Type="Document" URL="../bin/LabVIEW-libsvm.so"/>
